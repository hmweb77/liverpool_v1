  ...
  return (
    <div className="relative h-screen overflow-hidden">
      ...
      <div className="relative z-10 h-full flex flex-col items-center justify-center text-center px-4">
        <div>
          <h1 className="text-[2rem] md:text-[5rem] font-bold mb-6 leading-tight tracking-tight text-red-600 drop-shadow-[0_0_25px_rgba(220,38,38,0.5)]">
            {t('tagline')}
          </h1>
        ...
        <div className="absolute bottom-32 left-0 right-0 flex justify-center">
          <div className="bg-red-600/90 backdrop-blur-sm px-8 py-2 sm:py-4 rounded-full shadow-lg transform hover:scale-105 transition-all duration-300">
